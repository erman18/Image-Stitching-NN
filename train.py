...
def train3(height, width, nb_epochs=10, batch_size=32, save_arch=False, load_weights=True):
    ...
    gradient_loss_avg = tf.keras.metrics.Mean(name='Avg. Gradient Loss')
    simple_loss_avg = tf.keras.metrics.Mean(name='Avg. Simple Loss (MSE)')
    ...
    def train_step(batch, return_dict=True):
        ...
        with tf.GradientTape() as tape:
            ...
            main_loss = c_loss + s_loss + mse_loss + grad_loss
